...
const vipPayListData = ref<VipListType[]>([])
const currentPayData = ref<VipListType>()
 ...
 * 选中支付项
 */
const onChangeCurrentPay = (item: VipListType) => {
...
<template>
  <div class="h-full bg-zinc-200 dark:bg-zinc-800 duration-400 xl:pt-1">
    ...
    >
      <!-- 移动端 navbar 处理 -->
      <m-navbar v-if="isMobileTerminal" sticky :leftClick="onNavbarLeftClick">
        精选会员
      </m-navbar>
